    ...
    style={{
      ...
      <nav>
        <div className="nav nav-tabs" id="nav-tab" role="tablist" style={{paddingLeft: "40%", backgroundColor: "#1d1d1d"}}>
          ...
          <button className="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false" onClick={() => setCount(1)}>Team</button>
          <button className="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false" onClick={() => setCount(2)}>Athlete</button>
        </div>
      </nav>
